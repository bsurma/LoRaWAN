...
#define GPS_UPDATE_TIMEOUT 150000
...
/* OTAA para*/
uint8_t devEui[] = { FILL_IN };
uint8_t appEui[] = { FILL_IN };
uint8_t appKey[] = { FILL_IN };
...
static void prepareTxFrame( uint8_t port )
{
  ...
  */
  ...
  appDataSize = 0;
  uint32_t data = (uint32_t)(lat * 1E7);
    appData[appDataSize++] = data >> 24;
    appData[appDataSize++] = data >> 16;
    appData[appDataSize++] = data >> 8;
    appData[appDataSize++] = data;
    data = (uint32_t)(lon * 1E7);
    appData[appDataSize++] = data >> 24;    
    appData[appDataSize++] = data >> 16;
    appData[appDataSize++] = data >> 8;
    appData[appDataSize++] = data;
